...
export interface IAddLiquidityDepositSelector {
...
export const AddLiquidityDepositSelector: React.FC<IAddLiquidityDepositSelector> = ({
  initialTokenFrom,
  initialTokenTo,
  initialFee,
  tokens,
...
export default AddLiquidityDepositSelector
