...
import TVLChart from './Charts/sBITZTVLChart/TVLChart'
            ...
            <Box className={cx(
                ...
                <Box className={classes.sectionContainer}>
                    ...
                    <Box className={classes.chartContainer}>
                        <SupplyChart lastStatsTimestamp={1750604221} isLoading={false} interval={Intervals.Daily} data={[{ timestamp: 1710604221, value: 4.32 }, { timestamp: 1750603221, value: 24.32 }, { timestamp: 1850603221, value: 34.32 }]} />
                    </Box>
                </Box>
                ...
                <Box className={classes.sectionContainer}>
                    ...
                    <Box className={classes.chartContainer}>
                        <TVLChart lastStatsTimestamp={1750604221} isLoading={false} interval={Intervals.Daily} data={[{ timestamp: 1710604221, value: 4.32 }, { timestamp: 1750603221, value: 24.32 }, { timestamp: 1850603221, value: 34.32 }]} />
                    </Box>
                </Box>
            </Box>
        </Box>
