...
const faqData = [
  {
    ...
    answer:
      'sBITZ is a liquid staking token you receive when you stake BITZ. It represents your staked position and automatically grows in value as staking rewards accumulate. Instead of claiming rewards manually, the value of sBITZ increases over time relative to BITZ, making it easy to hold, trade, or use across DeFi while still earning yield.'
  },
  {
