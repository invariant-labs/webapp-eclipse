                                    ...
                                    <>
                                        ...
                                        {slice.points.map(point => (
                                            ...
                                            >
                                                ...
                                                >
                                                    {point.serieId === 'BITZ' ? 'Staked' : 'Holding'}: {formatNumberWithSuffix(point.data.yFormatted)} BITZ
                                                </Typography>
                                            </Box>
                                        ))}
                                    </>
                ...
                {bitzData.length > 0 && (
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <Typography className={classes.bitzValue}>
                            Staked: {formatNumberWithSuffix(bitzData[bitzData.length - 1].y.toFixed(2))} BITZ
                        </Typography>
                    </Box>
                )}
                {sBitzData.length > 0 && (
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                        ...
                        <Typography className={classes.sBitzValue}>
                            Holding: {formatNumberWithSuffix(sBitzData[sBitzData.length - 1].y.toFixed(2))} BITZ
                        </Typography>
                    </Box>
                )}
            </Box>
