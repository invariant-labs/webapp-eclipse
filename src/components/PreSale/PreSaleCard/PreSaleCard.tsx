...
export const PreSaleCard: React.FC<PreSaleCardProps> = ({
    ...
    return (
        <GradientBorder borderRadius={24} opacity={0.9} borderWidth={2} borderColor={`linear-gradient(${gradientDirection} ,#A9B6BF26, ${gradientPrimaryColor})`} backgroundColor={`linear-gradient(${gradientDirection}, #ef84f500 0%, ${gradientPrimaryColor}40 100%), #202946`} innerClassName={classes.container}>
